...
class MinesweeperAI():
        ...
        for sentence1 in self.knowledge:
            for sentence2 in self.knowledge:
                ...
                if sentence1 == sentence2:
                    ...
                    conhecimento = Sentence(sentence2.cells-sentence1.cells, sentence2.count-sentence1.count)
                    
                    if conhecimento not in self.knowledge:
                        self.knowledge.append(conhecimento)
    ...
    def make_safe_move(self):
        ...
        if safes:
            return random.choice(list(safes))
